...
/**
 * This contract represents an ERC20 token backed by the Twin Finance platform.
 *
 ...
 */
contract TwinToken is ERC20Upgradeable, AccessControlUpgradeable, ERC2771Context {
    /**
     ...
     */
    function setName(string memory name_) public only2771Role(DEFAULT_ADMIN_ROLE) {
        _tokenName = name_;
    }
     ...
     */
    function setSymbol(string memory symbol_) public only2771Role(DEFAULT_ADMIN_ROLE) {
        _tokenSymbol = symbol_;
    }
}
